...
print `ssh fnode2 scp /diag/projects/virome/output_repository/dump_db/$prefix.tar.gz biohen.dbi.udel.edu:/opt/virome`;
print `ssh fnode2 ssh biohen.dbi.udel.edu '/opt/virome/bin/virome-analysis-transfer.sh $prefix.tar.gz'`;
