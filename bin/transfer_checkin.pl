...
print `ssh fnode1 scp /diag/projects/virome/output_repository/dump_db/$prefix.tar.gz biomix.dbi.udel.edu:/opt/virome`;
print `ssh fnode1 ssh biomix.dbi.udel.edu '/opt/virome/bin/virome-analysis-transfer.sh $prefix.tar.gz'`;
