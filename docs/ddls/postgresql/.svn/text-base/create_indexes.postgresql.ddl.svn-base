...
CREATE INDEX idx_feature_relationship02 ON feature_relationship (subject_id,object_id);
...
CREATE UNIQUE INDEX idx_featureloc07 ON featureloc (srcfeature_id, feature_id, rank);
...
CREATE UNIQUE INDEX uc1_phylotree ON phylotree_pub (phylotree_id, pub_id);
