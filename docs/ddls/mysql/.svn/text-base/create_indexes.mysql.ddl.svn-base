...
CREATE UNIQUE INDEX idx_feature06 ON feature (type_id, feature_id); 
CREATE UNIQUE INDEX idx_featureloc01 ON featureloc (feature_id, featureloc_id);
CREATE UNIQUE INDEX pk_featureprop ON featureprop (featureprop_id);
CREATE UNIQUE INDEX idx_analysisfeature01 ON analysisfeature (analysis_id, feature_id, pidentity, significance);

-- create remaining clustered indexes

CREATE UNIQUE INDEX pk_analysis ON analysis (analysis_id);
CREATE UNIQUE INDEX pk_cv ON cv (cv_id);
CREATE UNIQUE INDEX pk_cvterm ON cvterm (cvterm_id);
CREATE UNIQUE INDEX idx_cvterm_dbxref01 ON cvterm_dbxref (dbxref_id, cvterm_id);
CREATE UNIQUE INDEX pk_cvterm_relationship ON cvterm_relationship (cvterm_relationship_id);
CREATE UNIQUE INDEX pk_cvtermpath ON cvtermpath (cvtermpath_id);
CREATE UNIQUE INDEX pk_cvtermprop ON cvtermprop (cvtermprop_id);
CREATE UNIQUE INDEX pk_cvtermsynonym ON cvtermsynonym (cvtermsynonym_id);
CREATE UNIQUE INDEX pk_db ON db (db_id);
CREATE UNIQUE INDEX pk_dbxref ON dbxref (dbxref_id);
CREATE UNIQUE INDEX pk_dbxrefprop ON dbxrefprop (dbxrefprop_id);
CREATE UNIQUE INDEX pk_feature_cvterm ON feature_cvterm (feature_cvterm_id);
CREATE UNIQUE INDEX pk_feature_cvtermprop ON feature_cvtermprop (feature_cvtermprop_id);
CREATE UNIQUE INDEX idx_feature_dbxref01 ON feature_dbxref (dbxref_id, feature_id);
CREATE UNIQUE INDEX pk_feature_pub ON feature_pub (feature_pub_id);
CREATE UNIQUE INDEX pk_feature_relationship ON feature_relationship (feature_relationship_id);
CREATE UNIQUE INDEX pk_feature_relationship_pub ON feature_relationship_pub (feature_relationship_pub_id);
CREATE UNIQUE INDEX pk_feature_relationshipprop ON feature_relationshipprop (feature_relationshipprop_id);
CREATE UNIQUE INDEX pk_feature_relprop_pub ON feature_relprop_pub (feature_relprop_pub_id);
CREATE UNIQUE INDEX pk_feature_synonym ON feature_synonym (feature_synonym_id);
CREATE UNIQUE INDEX pk_featureprop_pub ON featureprop_pub (featureprop_pub_id);
CREATE UNIQUE INDEX pk_organism ON organism (organism_id);
CREATE UNIQUE INDEX pk_organism_dbxref ON organism_dbxref (organism_dbxref_id);
CREATE UNIQUE INDEX pk_organismprop ON organismprop (organismprop_id);
CREATE UNIQUE INDEX pk_project ON project (project_id);
CREATE UNIQUE INDEX pk_pub ON pub (pub_id);
CREATE UNIQUE INDEX pk_pub_dbxref ON pub_dbxref (pub_dbxref_id);
CREATE UNIQUE INDEX pk_pub_relationship ON pub_relationship (pub_relationship_id);
CREATE UNIQUE INDEX pk_pubprop ON pubprop (pubprop_id);
CREATE UNIQUE INDEX pk_synonym ON synonym (synonym_id);
CREATE UNIQUE INDEX pk_tableinfo ON tableinfo (tableinfo_id);
CREATE UNIQUE INDEX pk_pubauthor ON pubauthor (pubauthor_id);
CREATE UNIQUE INDEX pk_phylotree ON phylotree (phylotree_id);
CREATE UNIQUE INDEX pk_phylotree_pub ON phylotree_pub (phylotree_pub_id);
CREATE UNIQUE INDEX pk_phylonode ON phylonode (phylonode_id);
CREATE UNIQUE INDEX pk_phylonode_dbxref ON phylonode_dbxref (phylonode_dbxref_id);
CREATE UNIQUE INDEX pk_phylonode_pub ON phylonode_pub (phylonode_pub_id);
CREATE UNIQUE INDEX pk_phylonode_organism ON phylonode_organism (phylonode_organism_id);
CREATE UNIQUE INDEX pk_phylonodeprop ON phylonodeprop (phylonodeprop_id);
CREATE UNIQUE INDEX pk_phylonode_relationship ON phylonode_relationship (phylonode_relationship_id);
CREATE UNIQUE INDEX pk_feature_cvterm_dbxref ON feature_cvterm_dbxref (feature_cvterm_dbxref_id);
CREATE UNIQUE INDEX pk_feature_cvterm_pub ON feature_cvterm_pub (feature_cvterm_pub_id);
...
-- BELOW IS DIE!  TABLE NOT EXIST -AARON
...
CREATE UNIQUE INDEX uc1_analysis ON analysis (program, programversion, sourcename);
CREATE UNIQUE INDEX pk_analysisfeature ON analysisfeature (analysisfeature_id);
CREATE UNIQUE INDEX uc1_analysisfeature ON analysisfeature (feature_id, analysis_id);
CREATE UNIQUE INDEX idx_analysisprop01 ON analysisprop(analysis_id, type_id, value);
CREATE UNIQUE INDEX uc1_cv ON cv (name);
CREATE UNIQUE INDEX idx_cvterm01 ON cvterm (cv_id, cvterm_id);
CREATE UNIQUE INDEX uc1_cvterm ON cvterm (name, cv_id, is_obsolete);
CREATE UNIQUE INDEX uc1_cvterm_dbxref ON cvterm_dbxref (cvterm_id, dbxref_id);
CREATE UNIQUE INDEX pk_cvterm_dbxref ON cvterm_dbxref (cvterm_dbxref_id);
CREATE UNIQUE INDEX uc1_cvterm_relationship ON cvterm_relationship (type_id, subject_id, object_id);
CREATE INDEX idx_cvterm_relationship01 ON cvterm_relationship (object_id);
CREATE INDEX idx_cvterm_relationship02 ON cvterm_relationship (subject_id);
CREATE UNIQUE INDEX uc1_cvtermpath ON cvtermpath (subject_id, object_id, type_id, pathdistance);
CREATE INDEX idx_cvtermpath01 ON cvtermpath (type_id);
CREATE INDEX idx_cvtermpath02 ON cvtermpath (cv_id);
CREATE INDEX idx_cvtermpath03 ON cvtermpath (object_id);
CREATE UNIQUE INDEX uc1_cvtermprop ON cvtermprop (cvterm_id, type_id, value, rank);
CREATE INDEX idx_cvtermprop01 ON cvtermprop (cvterm_id);
CREATE UNIQUE INDEX uc1_cvtermsynonym ON cvtermsynonym (cvterm_id, synonym);
CREATE INDEX idx_cvtermsynonym01 ON cvtermsynonym (cvterm_id);
CREATE UNIQUE INDEX uc1_db ON db (name);
CREATE UNIQUE INDEX uc1_dbxref ON dbxref (db_id, accession, version);
CREATE UNIQUE INDEX idx_dbxref01 ON dbxref (version, dbxref_id);
CREATE UNIQUE INDEX idx_dbxref02 ON dbxref (accession, dbxref_id);
CREATE UNIQUE INDEX uc1_dbxrefprop ON dbxrefprop (dbxref_id, type_id, value, rank);
CREATE INDEX idx_dbxrefprop01 ON dbxrefprop (dbxref_id);
CREATE INDEX idx_dbxrefprop02 ON dbxrefprop (type_id);
CREATE UNIQUE INDEX idx_feature02 ON feature (organism_id, uniquename, type_id);
CREATE UNIQUE INDEX idx_feature01 ON feature (feature_id);
CREATE UNIQUE INDEX idx_feature04 ON feature (dbxref_id, feature_id);
CREATE UNIQUE INDEX idx_feature03 ON feature (uniquename, feature_id);
CREATE INDEX idx_feature_cvterm01 ON feature_cvterm (pub_id);
CREATE UNIQUE INDEX idx_feature_cvterm02 ON feature_cvterm (cvterm_id, feature_id, feature_cvterm_id);
CREATE UNIQUE INDEX uc1_feature_cvtermprop ON feature_cvtermprop (feature_cvterm_id, type_id, rank);
CREATE INDEX idx_feature_cvtermprop01 ON feature_cvtermprop (type_id);
CREATE UNIQUE INDEX pk_feature_dbxref ON feature_dbxref (feature_dbxref_id);
CREATE UNIQUE INDEX uc1_feature_dbxref ON feature_dbxref (feature_id, dbxref_id);
CREATE UNIQUE INDEX uc1_feature_pub ON feature_pub (feature_id, pub_id);
CREATE INDEX idx_feature_pub01 ON feature_pub (pub_id);
CREATE UNIQUE INDEX uc1_feature_relationship ON feature_relationship (subject_id, object_id, type_id);
CREATE INDEX idx_feature_relationship01 ON feature_relationship (object_id);
CREATE UNIQUE INDEX uc1_feature_relationship_pub ON feature_relationship_pub (feature_relationship_id, pub_id);
CREATE INDEX idx_feature_relationship_pub01 ON feature_relationship_pub (pub_id);
CREATE UNIQUE INDEX uc1_feature_relationshipprop ON feature_relationshipprop (feature_relationship_id, type_id, rank);
CREATE INDEX idx_feature_relationshipprop01 ON feature_relationshipprop (type_id);
CREATE UNIQUE INDEX uc1_feature_relprop_pub ON feature_relprop_pub (feature_relationshipprop_id, pub_id);
CREATE INDEX idx_feature_relprop_pub01 ON feature_relprop_pub (pub_id);
CREATE UNIQUE INDEX uc1_feature_synonym ON feature_synonym (synonym_id, feature_id, pub_id);
CREATE INDEX idx_feature_synonym01 ON feature_synonym (pub_id);
CREATE INDEX idx_feature_synonym02 ON feature_synonym (feature_id);
CREATE UNIQUE INDEX uc1_featureloc ON featureloc (feature_id, locgroup, rank);
CREATE UNIQUE INDEX idx_featureloc02 ON featureloc (srcfeature_id, feature_id, featureloc_id);
CREATE INDEX idx_featureloc03 ON featureloc (srcfeature_id, fmin, fmax);
CREATE UNIQUE INDEX idx_featureloc06 ON featureloc (featureloc_id);
-- This next index deviates from the other database vendors because the value field is too
--  large for indexing in MySQL.  It is removed from this multi-key index.
CREATE UNIQUE INDEX uc1_featureprop ON featureprop (feature_id, type_id, rank);
CREATE INDEX idx_featureprop01 ON featureprop (type_id);
CREATE UNIQUE INDEX uc1_featureprop_pub ON featureprop_pub (featureprop_id, pub_id);
CREATE INDEX idx_featureprop_pub01 ON featureprop_pub (pub_id);
CREATE UNIQUE INDEX uc1_organism ON organism (genus, species);
CREATE UNIQUE INDEX uc1_organism_dbxref ON organism_dbxref (organism_id, dbxref_id);
CREATE INDEX idx_organism_dbxref01 ON organism_dbxref (organism_id);
CREATE INDEX idx_organism_dbxref02 ON organism_dbxref (dbxref_id);
CREATE UNIQUE INDEX uc1_organismprop ON organismprop (organism_id, type_id, value, rank);
CREATE INDEX idx_organismprop01 ON organismprop (type_id);
CREATE UNIQUE INDEX uc1_project ON project (name);
CREATE UNIQUE INDEX uc1_pub ON pub (uniquename, type_id);
CREATE INDEX idx_pub01 ON pub (type_id);
CREATE UNIQUE INDEX uc1_pubauthor ON pubauthor (pub_id, rank);
CREATE INDEX idx_pubauthor01 ON pubauthor (pub_id);
CREATE UNIQUE INDEX uc1_pub_dbxref ON pub_dbxref (pub_id, dbxref_id);
CREATE INDEX idx_pub_dbxref01 ON pub_dbxref (pub_id);
CREATE INDEX idx_pub_dbxref02 ON pub_dbxref (dbxref_id);
CREATE UNIQUE INDEX uc1_pub_relationship ON pub_relationship (subject_id, object_id, type_id);
CREATE INDEX idx_pub_relationship01 ON pub_relationship (type_id);
CREATE INDEX idx_pub_relationship02 ON pub_relationship (object_id);
CREATE UNIQUE INDEX uc1_pubprop ON pubprop (pub_id, type_id, value);
CREATE INDEX idx_pubprop01 ON pubprop (type_id);
CREATE UNIQUE INDEX uc1_synonym ON synonym (name, type_id);
CREATE INDEX idx_synonym01 ON synonym (type_id);
CREATE UNIQUE INDEX uc1_tableinfo ON tableinfo (name);
CREATE UNIQUE INDEX uc1_phylotree_pub ON phylotree_pub (phylotree_id, pub_id);
CREATE INDEX idx_phylotree_pub01 ON phylotree_pub (phylotree_id);
CREATE INDEX idx_phylotree_pub02 ON phylotree_pub (pub_id);
CREATE UNIQUE INDEX uc1_phylonode ON phylonode (phylotree_id, left_idx);
CREATE UNIQUE INDEX uc2_phylonode ON phylonode (phylotree_id, right_idx);
CREATE INDEX idx_phylonode01 ON phylonode (phylotree_id);
CREATE INDEX idx_phylonode02 ON phylonode (type_id);
CREATE INDEX idx_phylonode03 ON phylonode (feature_id);
CREATE UNIQUE INDEX uc1_phylonode_dbxref ON phylonode_dbxref (phylonode_id, dbxref_id);
CREATE INDEX idx_phylonode_dbxref01 ON phylonode_dbxref (phylonode_id);
CREATE INDEX idx_phylonode_dbxref02 ON phylonode_dbxref (dbxref_id);
CREATE UNIQUE INDEX uc1_phylonode_pub ON phylonode_pub (phylonode_id, pub_id);
CREATE INDEX idx_phylonode_pub01 ON phylonode_pub (phylonode_id);
CREATE INDEX idx_phylonode_pub02 ON phylonode_pub (pub_id);
CREATE UNIQUE INDEX uc1_phylonode_organism ON phylonode_organism (phylonode_id, organism_id);
CREATE INDEX idx_phylonode_organism01 ON phylonode_organism (phylonode_id);
CREATE INDEX idx_phylonode_organism02 ON phylonode_organism (organism_id);
CREATE UNIQUE INDEX uc1_phylonodeprop ON phylonodeprop (phylonode_id, type_id, value, rank);
CREATE INDEX idx_phylonodeprop01 ON phylonodeprop (phylonode_id);
CREATE INDEX idx_phylonodeprop02 ON phylonodeprop (type_id);
CREATE UNIQUE INDEX uc1_phylonode_relationship ON phylonode_relationship (subject_id, object_id, type_id);
CREATE INDEX idx_phylonode_relationship01 ON phylonode_relationship (subject_id);
CREATE INDEX idx_phylonode_relationship02 ON phylonode_relationship (object_id);
CREATE INDEX idx_phylonode_relationship03 ON phylonode_relationship (type_id);
CREATE UNIQUE INDEX uc1_feature_cvterm_dbxref ON feature_cvterm_dbxref (feature_cvterm_id, dbxref_id);
CREATE INDEX idx_feature_cvterm_dbxref01 ON feature_cvterm_dbxref (feature_cvterm_id);
CREATE INDEX idx_feature_cvterm_dbxref02 ON feature_cvterm_dbxref (dbxref_id);
CREATE UNIQUE INDEX uc1_feature_cvterm_pub ON feature_cvterm_pub (feature_cvterm_id, pub_id);
CREATE INDEX idx_feature_cvterm_pub01 ON feature_cvterm_pub (feature_cvterm_id);
CREATE INDEX idx_feature_cvterm_pub02 ON feature_cvterm_pub (pub_id);
--
-- Infection Module indices and constraints follow
--
CREATE UNIQUE INDEX uc1_infection ON infection (pathogen_id, hostres_id, disease_id);
CREATE INDEX idx_infection01 ON infection (infection_id);
CREATE INDEX idx_infection02 ON infection (pathogen_id);
CREATE INDEX idx_infection03 ON infection (hostres_id);
CREATE INDEX idx_infection04 ON infection (disease_id);
...
CREATE INDEX idx_incident01 ON incident (date_start);
CREATE INDEX idx_incident02 ON incident (date_end);
...
--
CREATE INDEX idx_contact01 ON contact (type_id,name);
CREATE INDEX idx_contact_relationship01 ON contact_relationship (type_id, subject_id, object_id);
CREATE INDEX idx_contactprop01 ON contactprop (contact_id, type_id, value);

--
-- Genetic module indices follow
--
CREATE UNIQUE INDEX uc1_genotype ON genotype (uniquename);
CREATE INDEX idx_genotype01 ON genotype (name);
CREATE UNIQUE INDEX uc1_feature_genotype ON feature_genotype (feature_id, genotype_id, cvterm_id, chromosome_id, rank, cgroup);
CREATE INDEX idx_feature_genotype01 ON feature_genotype (feature_id);
CREATE INDEX idx_feature_genotype02 ON feature_genotype (genotype_id);
CREATE UNIQUE INDEX uc1_environment ON environment (uniquename);
CREATE UNIQUE INDEX uc1_environment_cvterm ON environment_cvterm (environment_id, cvterm_id);
...
CREATE UNIQUE INDEX uc1_phenstatement ON phenstatement (genotype_id, phenotype_id, environment_id, type_id, pub_id);
CREATE INDEX idx_phenstatement01 ON phenstatement (genotype_id);
CREATE INDEX idx_phenstatement02 ON phenstatement (phenotype_id);
CREATE UNIQUE INDEX uc1_phendesc ON phendesc (genotype_id, environment_id, type_id, pub_id);
CREATE INDEX idx_phendesc01 ON phendesc (genotype_id);
CREATE INDEX idx_phendesc02 ON phendesc (environment_id);
CREATE INDEX idx_phendesc03 ON phendesc (pub_id);
CREATE UNIQUE INDEX uc1_phenotype_comparison ON phenotype_comparison (genotype1_id, environment1_id, genotype2_id, environment2_id, phenotype1_id, pub_id);
CREATE INDEX idx_phenotype_comparison01 ON phenotype_comparison (genotype1_id);
CREATE INDEX idx_phenotype_comparison02 ON phenotype_comparison (genotype2_id);
CREATE INDEX idx_phenotype_comparison03 ON phenotype_comparison (pub_id);
CREATE UNIQUE INDEX uc1_phenotype_comparison_cvterm ON phenotype_comparison_cvterm (phenotype_comparison_id, cvterm_id);
CREATE INDEX idx_phenotype_comparison_cvterm01 ON phenotype_comparison_cvterm (phenotype_comparison_id);
CREATE INDEX idx_phenotype_comparison_cvterm02 ON phenotype_comparison_cvterm (cvterm_id);

--
-- Stock module indices follow
--
CREATE UNIQUE INDEX uc1_stock ON stock (organism_id, uniquename, type_id);
CREATE INDEX idx_stock01 ON stock (dbxref_id);
CREATE INDEX idx_stock02 ON stock (organism_id);
CREATE INDEX idx_stock03 ON stock (type_id);
CREATE INDEX idx_stock04 ON stock (uniquename);
CREATE UNIQUE INDEX uc1_stock_pub ON stock_pub (stock_id, pub_id);
CREATE INDEX idx_stock_pub01 ON stock_pub (stock_id);
CREATE INDEX idx_stock_pub02 ON stock_pub (pub_id);
CREATE UNIQUE INDEX uc1_stockprop ON stockprop (stock_id, type_id, value, rank);
CREATE INDEX idx_stockprop01 ON stockprop (stock_id);
CREATE INDEX idx_stockprop02 ON stockprop (type_id);
CREATE UNIQUE INDEX uc1_stockprop_pub ON stockprop_pub (stockprop_id, pub_id);
CREATE INDEX idx_stockprop_pub01 ON stockprop_pub (stockprop_id);
CREATE INDEX idx_stockprop_pub02 ON stockprop_pub (pub_id);
CREATE UNIQUE INDEX uc1_stock_relationship ON stock_relationship (subject_id, object_id, type_id, rank);
CREATE INDEX idx_stock_relationship01 ON stock_relationship (subject_id);
CREATE INDEX idx_stock_relationship02 ON stock_relationship (object_id);
CREATE INDEX idx_stock_relationship03 ON stock_relationship (type_id);
