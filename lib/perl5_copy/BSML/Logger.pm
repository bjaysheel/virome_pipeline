...
# $Id: Logger.pm 519 2006-06-20 17:43:47Z angiuoli $

# Copyright (c) 2002, The Institute for Genomic Research. All rights reserved.

=head1 NAME

Logger.pm - A module for providing debugging methods to BSML and BSML projects.
...
This module is intended to provide BSML, and BSML client projects, with an easy to
...
my $logger = new BSML::Logger('LOG_LEVEL'=>2, #verbose debugging
			       'LOG_FILE'=>my.log
			       );

B<Returns:> $self (A BSML::Logger object).
