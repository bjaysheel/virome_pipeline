package Coati::Coati::BulkSybaseOmniumCoatiDB;

# $Id: BulkSybaseOmniumCoatiDB.pm,v 1.6 2003-12-01 23:16:35 angiuoli Exp $

# Copyright (c) 2002, The Institute for Genomic Research. All rights reserved.

=head1 NAME

BulkSybaseOmniumCoatiDB.pm - One line summary of purpose of class (or file).

=head1 VERSION

This document refers to version N.NN of BulkSybaseOmniumCoatiDB.pm, released MMMM, DD, YYYY.
...
use strict;
use base qw(Coati::BulkSybaseHelper Coati::Coati::SybaseOmniumCoatiDB);

sub test_BulkSybaseOmniumCoatiDB {
    my ($self, @args) = @_;
...
sub testDB {
    my ($self, @args) = @_;
    $self->{_logger}->info("Hello from :",__PACKAGE__,"!!!\n");
    return $self->test_BulkSybaseOmniumCoatiDB();
}
