package Coati::Coati::SybaseOmniumCoatiDB;

# $Id: SybaseOmniumCoatiDB.pm,v 1.5 2003-12-01 23:16:36 angiuoli Exp $
...
use strict;
use base qw(Coati::Coati::OmniumCoatiDB Coati::SybaseHelper);
