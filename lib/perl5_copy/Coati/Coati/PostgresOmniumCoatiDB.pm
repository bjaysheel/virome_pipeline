package Coati::Coati::PostgresOmniumCoatiDB;

# $Id: PostgresOmniumCoatiDB.pm,v 1.6 2003-12-01 23:16:36 angiuoli Exp $

# Copyright (c) 2002, The Institute for Genomic Research. All rights reserved.

=head1 NAME

PostgresOmniumCoatiDB.pm - One line summary of purpose of class (or file).

=head1 VERSION

This document refers to version N.NN of PostgresOmniumCoatiDB.pm, released MMMM, DD, YYYY.
...
use strict;
use base qw(Coati::Coati::OmniumCoatiDB Coati::PostgresHelper);

sub test_PostgresOmniumCoatiDB {
    my ($self, @args) = @_;
...
sub testDB {
    my ($self, @args) = @_;
    $self->{_logger}->info("Hello from :",__PACKAGE__,"!!!\n");
    return $self->test_PostgresOmniumCoatiDB();
}
