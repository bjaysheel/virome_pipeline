package Coati::Coati::MysqlOmniumCoatiDB;

# $Id: MysqlOmniumCoatiDB.pm,v 1.5 2003-12-01 23:16:36 angiuoli Exp $

# Copyright (c) 2002, The Institute for Genomic Research. All rights reserved.

=head1 NAME

MysqlOmniumCoatiDB.pm - One line summary of purpose of class (or file).

=head1 VERSION

This document refers to version N.NN of MysqlOmniumCoatiDB.pm, released MMMM, DD, YYYY.
...
use strict;
use base qw(Coati::Coati::OmniumCoatiDB Coati::MysqlHelper);

sub test_MysqlOmniumCoatiDB {
    my ($self, @args) = @_;
...
sub testDB {
    my ($self, @args) = @_;
    $self->{_logger}->info("Hello from :",__PACKAGE__,"!!!\n");
    return $self->test_MysqlOmniumCoatiDB();
}
