...
# $Id: Logger.pm 4647 2007-03-28 18:49:45Z sundaram $

# Copyright (c) 2002, The Institute for Genomic Research. All rights reserved.

=head1 NAME

Logger.pm - A module for providing debugging methods to GFF3 and GFF3 projects.
...
This module is intended to provide GFF3, and GFF3 client projects, with an easy to
...
my $logger = new GFF3::Logger( 'LOG_LEVEL'=>2, #verbose debugging
			       'LOG_FILE'=> 'my.gff3.log
			       );

B<Returns:> $self (A GFF3::Logger object).
