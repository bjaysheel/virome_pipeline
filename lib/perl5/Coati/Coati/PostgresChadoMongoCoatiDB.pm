package Coati::Coati::PostgresChadoMongoCoatiDB;

# $Id: PostgresChadoMongoCoatiDB.pm,v 1.2 2007-05-15 14:23:05 dbeatle123 Exp $

# Copyright (c) 2002, The Institute for Genomic Research. All rights reserved.

=head1 NAME

PostgresChadoMongoCoatiDB.pm - One line summary of purpose of class (or file).

=head1 VERSION

This document refers to version N.NN of PostgresChadoMongoCoatiDB.pm, released MMMM, DD, YYYY.
...
sub test_PostgresChadoMongoCoatiDB {
    my ($self, @args) = @_;
...
sub testDB {
    my ($self, @args) = @_;
    $self->{_logger}->info("Hello from :",__PACKAGE__,"!!!\n");
    return $self->test_PostgresChadoMongoCoatiDB();
}
