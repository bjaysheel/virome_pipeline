package Coati::Logger;

# $Id: Logger.pm,v 1.18 2006-06-07 15:19:52 angiuoli Exp $

# Copyright (c) 2002, The Institute for Genomic Research. All rights reserved.

=head1 NAME

Logger.pm - A module for providing debugging methods to Coati and Coati projects.
...
This module is intended to provide Coati, and Coati client projects, with an easy to
...
my $logger = new Coati::Logger('LOG_LEVEL'=>2, #verbose debugging
			       'LOG_FILE'=>my.log
			       );

B<Returns:> $self (A Coati::Logger object).
...
B<Description:> Set up Log4Perl default logger.  All other loggers will inherit from this logger.
