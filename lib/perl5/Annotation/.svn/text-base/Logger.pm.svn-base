...
# $Id: Logger.pm,v 1.1 2008/01/18 15:20:22 sundaram Exp $

# Copyright (c) 2002, The Institute for Genomic Research. All rights reserved.

=head1 NAME

Logger.pm - A module for providing debugging methods to Annotation and Annotation projects.
...
This module is intended to provide Annotation, and Annotation client projects, with an easy to
...
my $_DEFAULT_LOG_CATEGORY = "Annotation";
my $_IS_INIT=0;
...
my $logger = new Annotation::Logger( 'LOG_LEVEL'=>2, #verbose debugging
			       'LOG_FILE'=> 'my.annotation.log'
			       );

B<Returns:> $self (A Annotation::Logger object).
