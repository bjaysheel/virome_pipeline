...
XS(XS_DBI__clone_dbis); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI__clone_dbis)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBI__new_handle); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI__new_handle)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBI_dbi_time); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI_dbi_time)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_DBI_dbi_profile); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI_dbi_profile)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBI_dbi_profile_merge_nodes); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI_dbi_profile_merge_nodes)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBI__concat_hash_sorted); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI__concat_hash_sorted)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBI_sql_type_cast); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI_sql_type_cast)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBD_____dr_dbixs_revision); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBD_____dr_dbixs_revision)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBD_____db_connected); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBD_____db_connected)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBD_____db_preparse); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBD_____db_preparse)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBD_____db_take_imp_data); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBD_____db_take_imp_data)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBD_____st_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBD_____st_DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBI__st_TIEHASH); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBI__st_TIEHASH)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBD_____common_set_err); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBD_____common_set_err)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_DBD_____common_swap_inner_handle); /* prototype to pass -Wmissing-prototypes */
XS(XS_DBD_____common_swap_inner_handle)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(boot_DBI)
{
...

    {
        ...
        newXS("DBI::_clone_dbis", XS_DBI__clone_dbis, file);
        newXS("DBI::_new_handle", XS_DBI__new_handle, file);
        ...
        newXS("DBI::dbi_time", XS_DBI_dbi_time, file);
        newXS("DBI::dbi_profile", XS_DBI_dbi_profile, file);
        cv = newXS("DBI::dbi_profile_merge", XS_DBI_dbi_profile_merge_nodes, file);
        XSANY.any_i32 = 1 ;
        cv = newXS("DBI::dbi_profile_merge_nodes", XS_DBI_dbi_profile_merge_nodes, file);
        XSANY.any_i32 = 0 ;
        newXS("DBI::_concat_hash_sorted", XS_DBI__concat_hash_sorted, file);
        newXS("DBI::sql_type_cast", XS_DBI_sql_type_cast, file);
        newXS("DBI::var::FETCH", XS_DBI__var_FETCH, file);
        newXS("DBD::_::dr::dbixs_revision", XS_DBD_____dr_dbixs_revision, file);
        newXS("DBD::_::db::connected", XS_DBD_____db_connected, file);
        newXS("DBD::_::db::preparse", XS_DBD_____db_preparse, file);
        newXS("DBD::_::db::take_imp_data", XS_DBD_____db_take_imp_data, file);
        ...
        newXS("DBD::_::st::DESTROY", XS_DBD_____st_DESTROY, file);
        newXS("DBI::st::TIEHASH", XS_DBI__st_TIEHASH, file);
        ...
        newXS("DBD::_::common::set_err", XS_DBD_____common_set_err, file);
        ...
        newXS("DBD::_::common::swap_inner_handle", XS_DBD_____common_swap_inner_handle, file);
